  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-white p-4 sm:p-6 lg:p-8">
      <header className="flex justify-between items-center mb-8">
        <h1 className="text-3xl font-bold text-green-800">Benvenuto, Socio!</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <Card className="shadow-lg rounded-lg">
          ...
          <CardContent>
            ...
            <Link to="/book">
              <Button className="w-full bg-green-700 hover:bg-green-800 text-white">Vai al Calendario</Button>
            </Link>
          </CardContent>
        </Card>
        ...
        <Card className="shadow-lg rounded-lg">
          ...
          <CardContent>
            ...
            <Link to="/history">
              <Button variant="outline" className="w-full text-green-700 border-green-700 hover:bg-green-50">Vedi Storico</Button>
            </Link>
          </CardContent>
        </Card>
