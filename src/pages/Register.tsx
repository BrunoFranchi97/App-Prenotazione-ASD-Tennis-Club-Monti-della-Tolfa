    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-green-50 to-white p-4">
      <Card className="w-full max-w-md shadow-lg rounded-lg">
        <CardHeader className="text-center">
          <CardTitle className="text-3xl font-bold text-green-800">Registrati</CardTitle>
        ...
        <CardContent className="space-y-4">
          ...
          <Button className="w-full bg-green-700 hover:bg-green-800 text-white">Registrati</Button>
        </CardContent>
        <CardFooter className="text-sm text-center">
          <Link to="/login" className="text-green-700 hover:underline">Hai già un account? Accedi</Link>
        </CardFooter>
      </Card>
    </div>
  );
