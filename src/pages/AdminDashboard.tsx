  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-white p-4 sm:p-6 lg:p-8">
      <header className="flex justify-between items-center mb-8">
        <h1 className="text-3xl font-bold text-green-800">Pannello Amministrativo</h1>
        ...
        <Card className="shadow-lg rounded-lg">
          ...
          <CardContent>
            ...
            <Link to="/admin/manage-schedules">
              <Button className="w-full bg-green-700 hover:bg-green-800 text-white">Gestisci</Button>
            </Link>
          </CardContent>
        </Card>
        ...
        <Card className="shadow-lg rounded-lg">
          ...
          <CardContent>
            ...
            <Link to="/admin/block-slots">
              <Button variant="outline" className="w-full text-green-700 border-green-700 hover:bg-green-50">Blocca</Button>
            </Link>
          </CardContent>
        </Card>
        ...
        <Card className="shadow-lg rounded-lg">
          ...
          <CardContent>
            ...
            <Link to="/admin/usage-stats">
              <Button variant="outline" className="w-full text-green-700 border-green-700 hover:bg-green-50">Vedi Statistiche</Button>
            </Link>
          </CardContent>
        </Card>
      </div>
