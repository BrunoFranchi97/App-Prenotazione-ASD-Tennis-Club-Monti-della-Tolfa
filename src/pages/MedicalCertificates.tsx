...
import { ArrowLeft, LogOut, FileText, Plus, AlertTriangle, CheckCircle, Clock, Trash2, Edit } from 'lucide-react';
                        ...
                        <AlertDialog>
                          ...
                          <AlertDialogContent>
                            ...
                            <AlertDialogFooter>
                              ...
                              <AlertDialogAction onClick={() => handleDelete(currentCertificate.id)}>
                                Conferma
                              </AlertDialogAction>
                            </AlertDialogFooter>
                          </AlertDialogContent>
      ...
      <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Inserisci i dati del tuo certificato medico sportivo.
            </DialogDescription>
          </DialogHeader>
